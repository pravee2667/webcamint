...
def Face_verify(image1,image2):
    ...
    #image1=os.path.join('C:/Users/banoth.sunil/Documents/WebCam/Data/download.png')
    #image2=os.path.join('C:/Users/banoth.sunil/Documents/WebCam/Data/capture1.png')
